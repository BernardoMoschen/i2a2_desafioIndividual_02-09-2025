...
def build_histogram(dataset: Any, column: str, *, title: Optional[str] = None, return_fig: bool = False) -> Any:
    ...
    if return_fig:
        return {"plot_path": str(path), "figure": fig}
    return str(path)


def build_scatter(dataset: Any, x: str, y: str, *, color: Optional[str] = None, title: Optional[str] = None, return_fig: bool = False) -> Any:
